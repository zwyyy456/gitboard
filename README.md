...
Connect automation from Settings to map PR progress to three existing Project Status options. The automation runs in the hosted Worker, so GitStride does not need to remain open.
